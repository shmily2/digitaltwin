  ...
  methods: {
    ...
    initPlugin(callback) {
      ...
      that.oWebControl = new WebControl({
        szPluginContainer: "setting", // 指定容器id
          ...
          that.oWebControl
            ...
            .then(
              function () {
                ...
                that.oWebControl
                  .JS_CreateWnd("setting", that.videoWidth, that.videoHeight)
                  .then(() => {
    ...
    setWndCover() {
      ...
      let oDivRect = document.getElementById("setting").getBoundingClientRect();
